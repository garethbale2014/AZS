...
public class ProjectEditor {
  ...
  private class ActionSave extends Action {
    ...
    public void run() {
      ...
      PresentationWorkOrder.getInstance().addOrder(workOrder);
  ...
  private void openBrowser() {
    ...
    Bundle plugin = Activator.getDefault().getBundle(); // Where Activator is my
  ...
  public void setWorkOrder(WorkOrder workOrder) {
    ...
    this.personComposite.setOrder(this.workOrder);
  }
