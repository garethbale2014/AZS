...
public class BAHandler extends WiredHandler {
  ...
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ...
    for (WorkOrder order : SelectionUtils.getIterable(selection, WorkOrder.class)) {
      log.log(LogService.LOG_INFO, "create a bestattungsauftrag/leistungsnachweis: " + order); //$NON-NLS-1$
      try {
        FormularName f = FormularName.BAL;
