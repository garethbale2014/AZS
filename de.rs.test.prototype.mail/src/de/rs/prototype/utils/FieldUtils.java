...
import de.rs.prototype.firdaous.model.FieldInfo;
import de.rs.prototype.firdaous.model.FieldInfoList;
import de.rs.prototype.firdaous.model.PDFNameProperty;
          ...
          if (pdfNameTmp != null) {
            ...
            switch (pdfNameTmp) {
              ...
              case otherDeceder01BirthPlace:
                ...
                pdfName = pdfNameTmp.getPdfFieldName().getValue();
                fieldInfoList.add(new FieldInfo(pdfName, pdfName, value+"first"));
                break;
              case otherDeceder02:
                pdfName = pdfNameTmp.getPdfFieldName().getValue();
              ...
              case otherDeceder02BirthPlace:
                ...
                fieldInfoList.add(new FieldInfo(pdfName, pdfName, value+"second"));
                break;
